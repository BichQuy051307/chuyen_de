...
<head>
    ...
    <meta name="description" content="Đến với mọi cửa hàng của Fuji Fruit, bạn đều được trải nghiệm và mua sắm những sản phẩm chất lượng cao, uy tín hàng đầu trên thị trường chăm sóc sức khỏe">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8 text-center" style="margin-bottom : 20px;">
                                                <div class="em-block-title">
                                                    <p class="h4 em-text-upercase"><span>Nhà sản phẩm</span>
                                                    </p>
                                                </div>
                                                ...
                                                <p style="color: #ffffff;">
                                                    Cơ sở 3: Số 125 Ngô Gia Tự, Phước Tiến, TP.Nha Trang
                                                </p>
                                                <p style="color: #ffffff;">
                                                    Cơ sở 4: số 784 đường 2/4, phường Vĩnh Phước, TP.Nha Trang
                                                </p>
                                            </div><!-- /.col-sm-4 -->
                            ...
                            <div class="row">
                                <div class="col-sm-24">
                                    <div class="em-footer-address"> 
                                        <address class="f-left">&copy; © 2018 Hệ thống hoa quả sạch Fuji Fruit</address>
                                    </div>
                                </div>
                            </div>
                        </div>
